...
namespace TicketingSystem.MigrationService.Migrations
{
    ...
    [Migration("20241108121236_AddPersonEmailColumn")]
    partial class AddPersonEmailColumn
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TicketingSystem.Common.Model.Database.Entities.Cart", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CartId = new Guid("f2f6583e-406f-46cc-bfd4-c4b54c6391f1"),
                            CartStatus = 1,
                            PaymentId = 1,
                            PersonId = 1
                        },
                        new
                        {
                            CartId = new Guid("2a56560b-46ff-4b14-9f1b-c3061c1b2cb0"),
                            CartStatus = 0,
                            PersonId = 1
                        });
                });
