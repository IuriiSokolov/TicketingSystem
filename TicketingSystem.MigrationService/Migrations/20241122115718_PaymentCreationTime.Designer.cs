...
namespace TicketingSystem.MigrationService.Migrations
{
    ...
    [Migration("20241122115718_PaymentCreationTime")]
    partial class PaymentCreationTime
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TicketingSystem.Common.Model.Database.Entities.Cart", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CartId = new Guid("290c7d6d-f3ab-4f90-8297-f25f0a8001f9"),
                            CartStatus = 1,
                            PaymentId = 1,
                            PersonId = 1
                        },
                        new
                        {
                            CartId = new Guid("38d5ff05-9838-4e92-8e94-3256066e8ba7"),
                            CartStatus = 0,
                            PersonId = 1
                        });
                });
            ...
            modelBuilder.Entity("TicketingSystem.Common.Model.Database.Entities.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PaymentId = 1,
                            CartId = new Guid("290c7d6d-f3ab-4f90-8297-f25f0a8001f9"),
                            CreationTime = new DateTime(2024, 11, 22, 11, 57, 18, 410, DateTimeKind.Utc).AddTicks(8487),
                            PaymentStatus = 1,
